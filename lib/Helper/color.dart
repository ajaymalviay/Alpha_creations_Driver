...
const Color primary = Color(0xffBB8D01);
const Color secondary = Color(0xffA86464);
const Color fontColor = Color(0xff080808);
const Color grad1Color = Color(0xffA86464);
const Color grad2Color = Color(0xffA86464);
const Color lightWhite2 = Color(0xffEEF2F3);

const Color disableColor = Color(0xffEEF2F9);
const Color pink = Color(0xffBB8D01);
